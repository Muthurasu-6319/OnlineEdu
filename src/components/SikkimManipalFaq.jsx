...
export default function SikkimManipalFaq() {
  const faqs = [
    {
      question: 'What online UG and PG programs are offered by Sikkim Manipal University Online?',
      answer: 'Sikkim Manipal University Online offers a wide range of undergraduate and postgraduate programs, including BBA, BCA, B.Com, MBA, MCA, M.Com, MA Economics, MA Journalism & Mass Communication, and M.Sc Mathematics.',
      active: true,
    },
    {
      question: 'Are Sikkim Manipal University Online degrees UGC entitled?',
      answer: 'Yes. The online degree programs offered by Sikkim Manipal University Jaipur are UGC-entitled and designed to provide a recognized higher education qualification.',
      active: false,
    },
    {
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
        ...
        <div className="lg:w-5/12 w-full flex flex-col gap-6">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#374151] leading-tight">
            Sikkim Manipal Online Programmes <br />
            FAQ Section
          </h2>
          <p className="text-sm font-semibold text-slate-600 leading-relaxed max-w-md">
            Find answers to common questions about Sikkim Manipal University Online programs, eligibility, admission process, course duration, fees, examinations, and career opportunities.
          </p>
