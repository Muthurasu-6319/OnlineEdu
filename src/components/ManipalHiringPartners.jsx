...
export default function ManipalHiringPartners() {
  const partners = [
    'Amazon', 'Microsoft', 'Google', 'Deloitte', 'KPMG', 'EY', 'PwC', 
    'Infosys', 'TCS', 'Accenture', 'Wipro', 'Capgemini', 'Cognizant', 
    'Cisco', 'Dell', 'ICICI Bank'
  ];
