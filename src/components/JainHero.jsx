...
import heroImage from '../assets/Jain/image 8 (6).png';
import jainLogo from '../assets/Jain/ju-kochi-Jainuniversity 1.png';

export default function JainHero({ onEnquiryClick }) {
  return (
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-1/2 rounded-2xl overflow-hidden shadow-xl relative group">
          ...
          <div className="absolute top-4 left-4 bg-white/80 backdrop-blur-sm p-3 rounded-lg shadow-sm z-10 border border-white/40">
            <img src={jainLogo} alt="Jain University Logo" className="h-12 object-contain" />
          </div>
        </div>
