...
export default function NiosCourses() {
  return (
    <section id="nios-courses" className="bg-white py-16 md:py-24 font-outfit">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-14 space-y-3">
          ...
          <p className="text-slate-500 text-sm md:text-base max-w-2xl mx-auto leading-relaxed font-medium">
            Government-recognised certificates through NIOS — flexible, affordable, and accepted across India for jobs, higher education, and government exams.
          </p>
        </div>
