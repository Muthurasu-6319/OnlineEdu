...
import manipalHeroBg from '../assets/Manipal/About Picture & social Media (1).png';
...
export default function ManipalHero({ onEnquiryClick }) {
  return (
    <section className="bg-white py-16 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
        {/* Left Image */}
        <div className="lg:w-1/2 w-full">
          <img src={manipalHeroBg} alt="Manipal University Campus" className="w-full h-auto object-cover shadow-sm" />
        </div>
